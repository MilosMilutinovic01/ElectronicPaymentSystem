package com.example.pspbackend.config;

import com.example.pspbackend.auth.JpaUserDetailsService;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> {
                    ...
                    auth.requestMatchers("/api/payment/create-payment").permitAll();
